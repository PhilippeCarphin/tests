...
/*******************************************************************************
 * This function takes an input string str, and an array of strings (values) and
 * replaces whatever is between occurrences of frontDelim,endDelim pairs with
 * the values in the array.
 * The i-th occurrence of delimiter pairs gets the i-th string in the values
 * array.
 * Normally, the thing in between the delimiters would be used to lookup a value
